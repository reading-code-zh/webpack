...
```js
var __webpack_exports__ = {}; // CONCATENATED MODULE: ./methods.js
/*!********************************!*\
...
const resetCounter = async () => {
	(
		await __webpack_require__
			.e(/*! import() */ 1)
			.then(__webpack_require__.bind(__webpack_require__, /*! ./counter */ 1))
	).reset();
};
...
setTimeout(async () => {
	const counter = await __webpack_require__
		.e(/*! import() */ 1)
		.then(__webpack_require__.bind(__webpack_require__, /*! ./counter */ 1));
	print(counter.value);
	counter.increment();
...
(n.m = t),
	...
	(o = o => {
		var t,
			r,
			{ ids: i, modules: a, runtime: s } = o,
			u = 0;
		for (t in a) n.o(a, t) && (n.m[t] = a[t]);
		for (s && s(n); u < i.length; u++)
			(r = i[u]), n.o(e, r) && e[r] && e[r][0](), (e[i[u]] = 0);
	}),
	(n.f.j = (t, r) => {
		...
		if (0 !== i)
			if (i) r.push(i[1]);
				...
				var a = import("./" + n.u(t)).then(o, o => {
					throw (0 !== e[t] && (e[t] = void 0), o);
				});
				(a = Promise.race([a, new Promise(o => (i = e[t] = [o]))])),
					r.push((i[1] = a));
			}
	});
const i = e => console.log(e);
setTimeout(async () => {
	const e = await n.e(946).then(n.bind(n, 946));
	i(e.value),
		e.increment(),
		e.increment(),
		e.increment(),
		i(e.value),
		await (async () => {
			(await n.e(946).then(n.bind(n, 946))).reset();
		})(),
		i(e.value);
}, 100);
```
