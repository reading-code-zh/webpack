  ...
  \****************/
			...
			/***/ (
				...
				/* harmony import */ var isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(/*! isomorphic-fetch */ 5);
	...
	/******/ __webpack_require__ => {
		...
		/******/ __webpack_require__.O(0, ["other-vendors"], () =>
			__webpack_exec__(6)
		);
  ...
  \******************/
			...
			/***/ (
				...
				/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! react-dom */ 1);
				...
				__webpack_require__
					.e(/*! import() */ "lazy_js")
					.then(__webpack_require__.bind(__webpack_require__, /*! ./lazy */ 8));
	...
	/******/ __webpack_require__ => {
		...
		/******/ __webpack_require__.O(
			0,
			["app", "react-vendors", "other-vendors"],
			() => __webpack_exec__(7)
		);
		/******/ var __webpack_exports__ = __webpack_require__.O();
		/******/
  ...
  \************************************/
	...
	/******/ __webpack_require__ => {
		...
		/******/ var __webpack_exports__ =
			(__webpack_exec__(0), __webpack_exec__(1), __webpack_exec__(2));
		/******/
	}
]);
```
