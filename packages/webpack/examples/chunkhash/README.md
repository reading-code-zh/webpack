		...
		<script>
			(() => {
				...
				(i.m = n),
					...
					(i.O = (r, t, o, n) => {
						if (!t) {
							...
							for (s = 0; s < e.length; s++) {
								for (var [t, o, n] = e[s], l = !0, u = 0; u < t.length; u++)
									(!1 & n || a >= n) &&
									Object.keys(i.O).every(e => i.O[e](t[u]))
										? t.splice(u--, 1)
										: ((l = !1), n < a && (a = n));
								if (l) {
									e.splice(s--, 1);
					...
					(i.e = e =>
						Promise.all(
							Object.keys(i.f).reduce((r, t) => (i.f[t](e, r), r), [])
						)),
					(i.u = e => e + ".[chunkhash].js"),
  ...
  \********************/
		...
		/***/ (
			...
			__webpack_require__
				.e(/*! import() */ 2)
				.then(
					__webpack_require__.t.bind(__webpack_require__, /*! ./async1 */ 1, 23)
				);
			__webpack_require__
				.e(/*! import() */ 3)
				.then(
					__webpack_require__.t.bind(__webpack_require__, /*! ./async2 */ 2, 23)
				);
