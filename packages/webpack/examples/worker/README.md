...
/******/ (() => {
	// webpackBootstrap
	/******/ "use strict";
	var __webpack_exports__ = {}; // CONCATENATED MODULE: ./chat-module.js
	/*!************************************!*\
				...
				switch (e.type) {
					case "message":
						(n = e.content),
							...
							s.push(`${c}: ${n}`);
					case "history":
						o.postMessage({ type: "history", history: s });
				}
				var n, c;
			};
	};
...
(() => {
	...
	(o.m = e),
		...
		(() => {
			...
			var r = (self.webpackChunk = self.webpackChunk || []),
				t = r.push.bind(r);
			r.push = r => {
				var [a, n, p] = r;
				for (var s in n) o.o(n, s) && (o.m[s] = n[s]);
				for (p && p(o); a.length; ) e[a.pop()] = 1;
				t(r);
			};
		})(),
		(onmessage = async e => {
			const { fibonacci: r } = await o.e(129).then(o.bind(o, 129)),
				t = JSON.parse(e.data);
			postMessage(`fib(${t}) = ${r(t)}`);
		});
})();
```
