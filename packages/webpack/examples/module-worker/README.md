...
const chatWorker = new SharedWorker(
	new URL(
		/* worker import */ __webpack_require__.p + __webpack_require__.u(348),
...
fib1.addEventListener("change", async () => {
	try {
		...
		const { fibonacci } = await __webpack_require__
			.e(/*! import() */ 129)
			.then(
				__webpack_require__.bind(__webpack_require__, /*! ./fibonacci */ 2)
			);
		const result = fibonacci(value);
		output1.innerText = `fib(${value}) = ${result}`;
	} catch (e) {
...
const fibWorker = new Worker(
	new URL(
		/* worker import */ __webpack_require__.p + __webpack_require__.u(631),
		__webpack_require__.b
	),
	{
		name: "fibonacci",
	...
	for (const port of e.ports) {
		port.onmessage = async event => {
			...
			switch (msg.type) {
				...
				// fallthrough
				case "history":
					const { history } = await __webpack_require__
						.e(/*! import() */ 192)
						.then(
							__webpack_require__.bind(
								__webpack_require__,
...
(n.m = t),
	...
	(n.f = {}),
	(n.e = e =>
		Promise.all(Object.keys(n.f).reduce((o, t) => (n.f[t](e, o), o), []))),
	(n.u = e => e + ".js"),
	...
	(o = o => {
		var t,
			r,
			{ ids: s, modules: i, runtime: a } = o,
			c = 0;
		for (t in i) n.o(i, t) && (n.m[t] = i[t]);
		for (a && a(n); c < s.length; c++)
			(r = s[c]), n.o(e, r) && e[r] && e[r][0](), (e[s[c]] = 0);
	}),
	(n.f.j = (t, r) => {
		...
		if (0 !== s)
			if (s) r.push(s[1]);
				...
				var i = import("./" + n.u(t)).then(o, o => {
					throw (0 !== e[t] && (e[t] = void 0), o);
				});
				(i = Promise.race([i, new Promise(o => (s = e[t] = [o]))])),
					r.push((s[1] = i));
			}
	}),
	(onconnect = function (e) {
		for (const o of e.ports)
			o.onmessage = async e => {
				...
				switch (t.type) {
					case "message":
						const { add: e } = await n.e(192).then(n.bind(n, 192));
						e(t.content, t.from);
					case "history":
						const { history: r } = await n.e(192).then(n.bind(n, 192));
...
onmessage = async event => {
	const { fibonacci } = await __webpack_require__
		.e(/*! import() */ 129)
		.then(__webpack_require__.bind(__webpack_require__, /*! ./fibonacci */ 2));
	const value = JSON.parse(event.data);
	postMessage(`fib(${value}) = ${fibonacci(value)}`);
};
```
...
(i.m = r),
	...
	(i.f = {}),
	(i.e = e =>
		Promise.all(Object.keys(i.f).reduce((o, r) => (i.f[r](e, o), o), []))),
	(i.u = e => e + ".js"),
	...
	(o = o => {
		var r,
			t,
			{ ids: a, modules: n, runtime: s } = o,
			f = 0;
		for (r in n) i.o(n, r) && (i.m[r] = n[r]);
		for (s && s(i); f < a.length; f++)
			(t = a[f]), i.o(e, t) && e[t] && e[t][0](), (e[a[f]] = 0);
	}),
	(i.f.j = (r, t) => {
		...
		if (0 !== a)
			if (a) t.push(a[1]);
				...
				var n = import("../" + i.u(r)).then(o, o => {
					throw (0 !== e[r] && (e[r] = void 0), o);
				});
				(n = Promise.race([n, new Promise(o => (a = e[r] = [o]))])),
					t.push((a[1] = n));
			}
	}),
	(onmessage = async e => {
		const { fibonacci: o } = await i.e(129).then(i.bind(i, 129)),
			r = JSON.parse(e.data);
		postMessage(`fib(${r}) = ${o(r)}`);
	});
```
